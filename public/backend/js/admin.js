$(document).ready(function () {
	...
	function setSideBarHeight(){
		var height;
		height = $('.sidebar').outerHeight()-$('.sidebar__logo').outerHeight() - $('.sidebar__user').outerHeight() - $('.sidebar__copyright').outerHeight()-50;
		if (height<=60) {
			$('.sidebar__nav').css("padding", "20px 30px");
		}
		$('.sidebar__nav').height(height);
	}
	setSideBarHeight();
