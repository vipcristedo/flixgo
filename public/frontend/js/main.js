$(document).ready(function () {
    ...
    $('.filter__item-menu li').on('click', function() {
        ...
        $('#'+id).find('.filter__item-btn .show').val(text);
        $('#'+id).find('.filter__item-btn .request').val(key);
    });
    ...
    //Chuyển chapter
    $('#chap_redirect').on('change',function () {
        let slug = $('#chap_redirect').val();
        let slug_manga= $(this).attr('data-manga');
        $(location).attr('href', '/manga/'+ slug_manga +'/'+slug);
    })
