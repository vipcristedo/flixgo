...
{{--                                        class="icon ion-ios-star"></i>{{ $movie['rate'] }}</span>--}}
                    ...
                    <div class="col-12">
                        ...
                        <div class="backup col-12 col-xl-6">
                            ...
                            <span @if($backup['id'] == $channel['id']) hidden @endif><a href="{{route('frontend.movie',[$movie['slug'],$backup['id'],$video['slug']])}}" class="btn">#{{$backup['title']}}</a></span>
                            @endforeach
                        ...
                        <div class="col-12 col-xl-6">
                            <div class="accordion" id="accordion">
                                ...
                                <div id="collapse{{$playlist['id']}}" class="collapse @if($playlist['id'] == $video['playlist_id']) show @endif" aria-labelledby="headingTwo"
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="accordion__list">
                                        ...
                                        <tbody>
                                            ...
                                            <tr @if($videos['id'] == $video['id'])class="video_active" @endif>
                                                <th>{{$videos['chap']}}</th>
                                                <td><a href="{{route('frontend.movie',[$movie['slug'],1,$videos['slug']])}}">{{$videos['title']}}</a></td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
